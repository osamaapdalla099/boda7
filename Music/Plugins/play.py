...
@Client.on_message(command(["/play", "بودا" ,"شغل" ,"تشغيل","امريكي","ايفل", f"/play@{BOT_USERNAME}", "تشغيل"]))
...
الغي الحظر الاكوانت المساعد عشان تعرف تستخدم البوت ياصحبي🎻
"""
            )
            return
...
"""
        ...
        if len(message.command) < 2:
            ...
            hmo = await message.reply_text(
                """
<b>**لازم يكون جنب الأمر أسم أو لينك الاغنيه**

**♡🥀اوامر التشغيل🥀♡**

تشغيل او شغل او ايفل او بودا + أسم الاغنيه 🎸
""",
            )
            return
        what = "Query Given"
        ...
        thumb ="https://telegra.ph/file/2f2c71eabe8a3f4e6736b.jpg"
