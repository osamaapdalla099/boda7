        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("الـدعـم", url=f"https://t.me/ELGMD"),
                    InlineKeyboardButton("الـسورس", url=f"https://t.me/Gaamd_23")
                ],[
                    InlineKeyboardButton(" 😈 ¦ المـطوريـن", url=f"https://t.me/Gaaaamd")
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("- 𝐆𝐑𝐎𝐔𝐏 -", url=f"https://t.me/ELGMD"),
