...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="جروب الدعم🌹​", url=f"https://t.me/ELGMD"),
            InlineKeyboardButton(text="قناة السورس🥀", url=f"https://t.me/Gaamd_23"),
        ],
        [
            InlineKeyboardButton("الاوامر🥀", url="https://t.me/music_mr_U/13"),
        ],
        [
            InlineKeyboardButton("⁨★ 𝙚𝙩𝙖𝙡𝙚𝙚 𝙢𝙪𝙨𝙞𝙘 ˹🥀˼⁩", url="https://t.me/Boda_MR"),
        ],
    ]
    return (
    ...
    for member in message.new_chat_members:
        try:
            ...
            if member.id in SUDOERS:
                return await message.reply_text(
                    f"نــورت يـرحــقلـبــي.💕🍓. [{member.mention}] جــروبـنـا المـتـواضـع + ممـنـوع الألفاظ الخارجه 🤫 + مـمنـوع الحج يعم الحك 🤺 + مـمنـوع نشر اللينكات او المعرفات ⛔ • غـيـر كـده انتـ شرفتـنا ياغـالي ـ💞ˣ᙮"
                )
            if member.id == ASSID:
