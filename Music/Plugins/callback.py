...
""",
        ...
        [
            InlineKeyboardButton("🥀╎support group", url=f"https://t.me/ELGMD"),
            InlineKeyboardButton("🥀╎Source channel", url=f"https://t.me/Gaamd_23"),
        ],
        [
...
""",
        ...
        [
            InlineKeyboardButton("جروب السورس💖", url=f"https://t.me/ELGMD"),
            InlineKeyboardButton("قناة السورس📣", url=f"https://t.me/Gaamd_23"),
        ],
        [
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [        
                    InlineKeyboardButton(
                        "⁨𝑩𝑶𝑫𝑨 𝑬𝑳𝑴𝑹𝑨𝒁𝑬 𓆩🖤🥀𓆪˼⁩", url=f"https://t.me/Gaaaamd"
                    ),
                ],
                [                  
                    InlineKeyboardButton(
