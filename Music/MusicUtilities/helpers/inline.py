...
def play_markup(videoid, user_id):
    buttons = [
        [
            InlineKeyboardButton(text="الدعم🥀", url=f"https://t.me/ELGMD"),
...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "الاوامـــر التشغيل هنا : 📚", url="https://t.me/music_mr_U/13"
            )
        ],
...
def start_pannel():
    ...
    if not CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="الدعم🥀 ", url=f"https://t.me/ELGMD"
                ),
            ],
        ]
    ...
    if CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/Gaamd_23"
                ),
                InlineKeyboardButton(
                    text="✨ sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/ELGMD"
                ),
            ],
        ]
        return f"🎛  **This is {BOT_NAME}**", buttons
